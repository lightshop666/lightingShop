				                  ...
				                  <form id="addressModifyForm" action="<%=request.getContextPath()%>/customer/modifyAddressAction.jsp?addressNo=<%=addressNo%>" method="post">
								    ...
								    <div>
										<!-- 카카오 다음 우편번호 서비스 JS API -->
											...
											<input class="mr-3 mb-1" type="text" id="sample3_postcode" placeholder="우편번호" readonly="readonly" value="<%=myAddress.getAddress().substring(0, 4) %>">
											<input class="ml-2 mb-1" type="button" onclick="sample3_execDaumPostcode()" value="우편번호 찾기"><br>
											<input class="mb-1" style="width:260px;" type="text" id="sample3_address" placeholder="주소" value="<%=myAddress.getAddress().substring(6) %>"><br>
