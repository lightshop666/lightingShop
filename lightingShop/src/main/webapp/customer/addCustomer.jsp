...
<div class="search-wrapper section-padding-100">
				                  ...
				                  <h2>회원 가입</h2>
									...
									<form id="addressAddForm" action="<%=request.getContextPath()%>/customer/addCustomerAction.jsp" method="post">
										...
										<table class="table">
											...
											<tr>
												<td>비밀번호를 입력해주세요.</td>
												<td><input type="password" name="lastPw" placeholder=""></td>
											</tr>
											<tr>
												<td>이름을 입력해주세요.</td>
											...
											<tr>
												<td>약관에 동의하시겠습니까?</td>
												<td><input type="checkbox" name="cstmAgree" value="Y" checked="checked"></td>
											</tr>
										</table>
	...
	document.querySelector('form').addEventListener('submit', function(event) {
		...
		if (lastPwInput.value.length < 4) {
		    event.preventDefault();
		    alert('PW는 4자이상이어야 합니다.');
		    return;
		} 
