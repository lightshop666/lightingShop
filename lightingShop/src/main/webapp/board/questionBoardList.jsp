...
<body>
	...
	<%
		...
		if(beginPage != 1) {
	%>
			<a href="<%=request.getContextPath()%>/board/questionBoardList.jsp?currentPage=<%=beginPage - 1%>&rowPerPage=<%=rowPerPage%>&qCategory=<%=qCategory%>&searchCategory=<%=searchCategory%>&searchWord=<%=searchWord%>">
				&laquo;
			</a>
	<%
		}
	...
	%>
				<a href="<%=request.getContextPath()%>/board/questionBoardList.jsp?currentPage=<%=i%>&rowPerPage=<%=rowPerPage%>&qCategory=<%=qCategory%>&searchCategory=<%=searchCategory%>&searchWord=<%=searchWord%>">
					<%=i%>
				</a>&nbsp;
	<%
			}
		...
		if(endPage != lastPage) {
	%>
			<a href="<%=request.getContextPath()%>/board/questionBoardList.jsp?currentPage=<%=endPage + 1%>&rowPerPage=<%=rowPerPage%>&qCategory=<%=qCategory%>&searchCategory=<%=searchCategory%>&searchWord=<%=searchWord%>">
				&raquo;
			</a>
	<%
		}
